...
IS_SAMPLE_DATA_BRANCH=`git ls-remote --heads https://${GHT_USER}:$GHT_TOKEN@github.tools.sap/cx-commerce/spartacussampledata.git $SAMPLE_DATA_NEW`
...
IS_SAMPLE_DATA_BRANCH=`git ls-remote --heads https://${GHT_USER}:$GHT_TOKEN@github.tools.sap/cx-commerce/spartacussampledata.git $SAMPLE_DATA_OLD`
